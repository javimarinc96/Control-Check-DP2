...
<form:form action="positionData/create.do?curriculaId=${curriculaId}" modelAttribute="positionData">
	...
	<input type="submit" name="save" value="<spring:message code="positionData.save"/>"/>
