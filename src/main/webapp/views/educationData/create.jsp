...
<form:form action="educationData/create.do?curriculaId=${curriculaId}" modelAttribute="educationData">
	...
	<acme:cancel code="educationData.cancel" url="curricula/show.do?curriculaId=${curriculaId}" />
